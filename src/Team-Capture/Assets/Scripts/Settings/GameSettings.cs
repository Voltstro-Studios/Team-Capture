...
namespace Team_Capture.Settings
{
    ...
    public static class GameSettings
    {
        ...
        [SettingsPropertyDisplayText("Text", "Settings_Mouse")]
        internal static MouseSettingsClass MouseSettings { get; } = new();

        [SettingsPropertyDisplayText("Text", "Settings_Video")]
        internal static VideoSettingsClass VideoSettings { get; } = new();

        [SettingsPropertyDisplayText("Text", "Settings_Adv")]
        internal static AdvSettingsClass AdvSettings { get; } = new();
