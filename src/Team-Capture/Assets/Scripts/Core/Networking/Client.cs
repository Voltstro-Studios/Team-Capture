...
namespace Team_Capture.Core.Networking
{
    ...
    internal static class Client
    {
        ...
        internal static ClientStatus Status { get; private set; }
        ...
        private static async UniTaskVoid DisplayMotdAndOrCreatePlayer()
        {
            ...
            if (netManager.serverConfig.MotdMode != Server.ServerMOTDMode.Disabled &&
                ClientMotdMode != ClientMOTDMode.Disable)
            {
                if (netManager.serverConfig.MotdMode == Server.ServerMOTDMode.WebOnly &&
