...
namespace Team_Capture.BootManagement
{
    ...
    internal class BootManager : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("How long do you want to wait between each boot item start")] [SerializeField]
        private float delayBetweenItems = 0.1f;

        /// <summary>
        ///     All the boot items you want to do
        /// </summary>
        [Tooltip("All the boot items you want to do")] [SerializeField]
        private BootItem[] bootItems;
