...
namespace Mirror
{
    ...
    public class NetworkReader
    {
        ...
        {
            if (Position + 1 > buffer.Count) throw new EndOfStreamException("ReadByte out of range:" + ToString());
        ...
        {
            return "NetworkReader pos=" + Position + " len=" + Length + " buffer=" +
    ...
    public static class NetworkReaderExtensions
    {
        ...
        {
            return checked((uint) reader.ReadPackedUInt64());
        }
        ...
        public static ulong ReadPackedUInt64(this NetworkReader reader)
        {
            ...
            if (a0 >= 241 && a0 <= 248) return 240 + ((a0 - (ulong) 241) << 8) + a1;
        ...
        {
            return new Vector3Int(reader.ReadPackedInt32(), reader.ReadPackedInt32(), reader.ReadPackedInt32());
        }
        ...
        public static NetworkIdentity ReadNetworkIdentity(this NetworkReader reader)
        {
            ...
            if (NetworkIdentity.spawned.TryGetValue(netId, out NetworkIdentity identity)) return identity;
