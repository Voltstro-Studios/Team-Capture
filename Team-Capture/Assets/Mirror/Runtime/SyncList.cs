...
namespace Mirror
{
    ...
    public abstract class SyncList<T> : IList<T>, IReadOnlyList<T>, SyncObject
    {
            ...
            for (int i = 0; i < changesCount; i++)
            {
                ...
                switch (operation)
                {
                    ...
                    case Operation.OP_INSERT:
                        ...
                        item = DeserializeItem(reader);
                        if (apply) objects.Insert(index, item);
                        break;
        ...
        private void AddOperation(Operation op, int itemIndex, T item)
        {
        ...
        private void AddOperation(Operation op, int itemIndex)
        {
            AddOperation(op, itemIndex, default);
        }
