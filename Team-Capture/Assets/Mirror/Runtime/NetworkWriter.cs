...
namespace Mirror
{
    ...
    public class NetworkWriter
    {
        ...
        {
            stream.Flush();
            if (stream.TryGetBuffer(out ArraySegment<byte> data)) return data;
            throw new Exception(
                "Cannot expose contents of memory stream. Make sure that MemoryStream buffer is publicly visible (see MemoryStream source code).");
        }
        ...
        {
            this.WriteRect(value);
        }

        [Obsolete("Use WritePlane instead")]
        public void Write(Plane value)
        {
            this.WritePlane(value);
        }
        ...
        {
            this.WriteNetworkIdentity(value);
        }
