...
namespace Mirror
{
    public class NetworkConnectionToClient : NetworkConnection
    {
        ...
        ///     <para>
        ///         This includes the player object for the connection - if it has localPlayerAutority set, and any objects
        ///         spawned with local authority or set with AssignLocalAuthority.
        ///     </para>
        ///     <para>
        ///         This list can be used to validate messages from clients, to ensure that clients are only trying to control
        ...
        internal static bool Send(List<int> connectionIds, ArraySegment<byte> segment,
