...
namespace Mirror
{
    ...
    public class NetworkRoomPlayer : NetworkBehaviour
    {
        ...
        ///     <para>
        ///         When all players are ready to begin, the game will start. This should not be set directly, the
        ///         SendReadyToBeginMessage function should be called on the client to set it on the server.
        ///     </para>
        /// </summary>
        ...
        ///     <para>
        ///         This function is called when the a client player calls SendReadyToBeginMessage() or
