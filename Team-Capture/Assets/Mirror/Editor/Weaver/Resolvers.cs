...
namespace Mirror.Weaver
{
    public static class Resolvers
    {
        ...
        public static MethodReference ResolveMethodInParents(TypeReference tr, AssemblyDefinition scriptDef,
            string name)
        {
            if (tr == null)
            {
        ...
        public static MethodReference ResolveMethodWithArg(TypeReference tr, AssemblyDefinition scriptDef, string name,
        ...
        public static GenericInstanceMethod ResolveMethodGeneric(TypeReference t, AssemblyDefinition scriptDef,
            string name, TypeReference genericType)
        {
                ...
                if (methodRef.Name == name)
                    if (methodRef.Parameters.Count == 0)
                        if (methodRef.GenericParameters.Count == 1)
                        {
                            ...
                            if (gm.GenericArguments[0].FullName == genericType.FullName) return gm;
                        }
