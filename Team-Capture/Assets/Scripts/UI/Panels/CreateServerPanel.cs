...
namespace Team_Capture.UI.Panels
{
    ...
    internal class CreateServerPanel : PanelBase
    {
        ...
        /// </summary>
        [Tooltip("Dropdown for Auth mode")] public TMP_Dropdown authModeDropdown;
        ...
        public void CreateGame()
        {
            ...
            if (!Directory.Exists($"{GameBuilder.GetBuildDirectory()}Team-Capture-Quick/"))
            {
        ...
        private void CreateServerProcess()
        {
            ...
            netManager.CreateServerProcess(gameNameText.text, onlineTCScenes[mapsDropdown.value].SceneFileName,
                maxPlayers, userProvider,
