...
namespace Weapons
{
	...
	public class TCWeapon : ScriptableObject
	{
		...
		public enum WeaponFireMode
		{
			...
			/// prepares it for subsequent firing, but requires the shooter to manually actuate the trigger in order to discharge each shot.
			/// </summary>
			Semi
		}
		...
		/// </summary>
		[Header("Weapon Stats")]
		[Tooltip("How much damage per bullet will this weapon do")]
		public int damage;
		...
		/// </summary>
		[Header("Spread")]
		[Tooltip("How much spread will this weapon have")]
		...
		/// </summary>
		[Header("Effects")]
		[Tooltip("The bullet hole prefab that will be used")]
